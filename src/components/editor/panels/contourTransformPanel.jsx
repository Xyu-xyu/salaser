...
const ContourTransformPanel = observer(() => {
	...
	return (
		<>
			{panelInfo.map((element, index) => (
				<Panel key={'contourTransformPanel' + index + 1} element={element} />
			))}
		</>
	);
})

export default ContourTransformPanel;
