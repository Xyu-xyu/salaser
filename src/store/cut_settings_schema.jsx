// TODO схема по идее должна загружаться и записываться сюда автоматически и
// сохраняться для создания дефолтных значений
// но учитываю отстутсвие связи с платой  пока так!
